...
class IERSTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testDistantDut1()
    {
        $this->setExpectedExceptionRegExp(Exception::class, '/No dut data/');
        $iers = IERS::jd(3182259);
        $iers->dut1();
    }

    public function testDistantDeltaT()
    {
        $this->setExpectedExceptionRegExp(Exception::class, '/No/');
        $iers = IERS::jd(3182259);
        $iers->deltaT();
    }
